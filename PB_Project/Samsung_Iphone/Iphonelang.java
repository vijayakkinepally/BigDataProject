...
public class Iphonelang {
 public static void main(String args[])
 {
 try {
   
	 FileWriter fw = new FileWriter("Iphonelang.csv");
  ...
  DB db = mongo.getDB("iphonelang"); // creating or getting database from mongodb
 
  DBCollection collection = db.getCollection("iphonelang_tweet_data"); // get collection
