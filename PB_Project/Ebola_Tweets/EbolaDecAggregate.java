...
public class EbolaDecAggregate {
	public static void main(String[] args )
	{
		try {
			...
			DBObject matchDec = new BasicDBObject("$match", new BasicDBObject("created_at", new BasicDBObject("$regex", ".*Dec.*")
			.append("$options", "i")));
			...
			int i=0;	
			 ...
			 FileWriter fw = new FileWriter("EbolaDec.csv");
